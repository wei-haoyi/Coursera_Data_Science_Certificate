...
setwd("~/Documents/GitHub/Coursera_Data_Science_Certificate/2_R Programming/Assignment_3")
...
outcome <-read.csv("../../Data/rprog_data_ProgAssignment3-data/outcome-of-care-measures.csv")
